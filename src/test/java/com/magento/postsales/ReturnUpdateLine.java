 ...
 */
public final class ReturnUpdateLine {
  /**
  ...
  /**
   * Status of the item in the return
   */
  ...
  @JsonCreator
  public ReturnUpdateLine(@JsonProperty(value = "id", required = true) final String id,
      ...
      @JsonProperty(value = "condition", required = true) final String condition,
